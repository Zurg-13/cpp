...
// Выбрана отправка в файл. ----------------------------------------------------
//------------------------------------------------------------------------------
void FMain::on_aFileDest_triggered() {
    FNC << "bgn";
}// on_aFileDest_triggered

// Выбрана отправка на ЯндексДиск. ---------------------------------------------
//------------------------------------------------------------------------------
void FMain::on_aYandexDest_triggered() {
    FNC << "bgn";
}// on_aYandexDest_triggered

// Выбрана отправка на гугл диск. ----------------------------------------------
//------------------------------------------------------------------------------
void FMain::on_aGoogleDest_triggered() {
    FNC << "bgn";
}// on_aGoogleDest_triggered

// Отправить файл. -------------------------------------------------------------
//------------------------------------------------------------------------------
void FMain::on_btSend_clicked() {
